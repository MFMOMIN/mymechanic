   ...
   <div class="col-md-9 personal-info">
      ...
      ?>      
        <form class="form-horizontal" role="form">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label">Garage Location:</label>
            <div class="col-lg-8">
              <input class="form-control" type="textarea" value="<?php  echo $row['location']; ?> "name="location">
            </div>
          </div>
          <div class="form-group">
...
include("DBconfig.php");
      ...
      $query = "UPDATE `garage_signup` SET `location` = $location WHERE `garage_signup`.`garage_id` = $garage_id'";
